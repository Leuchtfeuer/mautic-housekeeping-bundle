    ...
    public function runProvider(): array
    {
        ...
        $calls[] = [
            ...
            [
                ...
                [
                    'SELECT * FROM prefix_table_campaign_lead_event_log clel WHERE (clel.id NOT IN (SELECT MAX(clel2.id) FROM campaign_lead_event_log clel2) AND clel.date_triggered < DATE_SUB(NOW(),INTERVAL :daysOld DAY))',
                    [':daysOld' => $daysOld],
                    [':daysold' => \PDO::PARAM_INT],
                ],
                [
        ...
        $calls[] = [
            ...
            [
                ...
                [
                    'SELECT * FROM prefix_table_campaign_lead_event_log clel WHERE (clel.id NOT IN (SELECT MAX(clel2.id) FROM campaign_lead_event_log clel2) AND clel.date_triggered < DATE_SUB(NOW(),INTERVAL :daysOld DAY)) AND campaign_id = :cmpId',
                    [':daysOld' => $daysOld, ':cmpId' => 12235],
                    [':daysold' => \PDO::PARAM_INT, ':cmpId' => \PDO::PARAM_INT],
                ],
            ],
        ...
        $calls[] = [
            ...
            [
                ...
                [
                    'DELETE FROM prefix_table_campaign_lead_event_log clel WHERE (clel.id NOT IN (SELECT MAX(clel2.id) FROM campaign_lead_event_log clel2) AND clel.date_triggered < DATE_SUB(NOW(),INTERVAL :daysOld DAY))',
                    [':daysOld' => $daysOld],
                    [':daysold' => \PDO::PARAM_INT],
                ],
                [
        ...
        $calls[] = [
            ...
            [
                ...
                [
                    'DELETE FROM prefix_table_campaign_lead_event_log clel WHERE (clel.id NOT IN (SELECT MAX(clel2.id) FROM campaign_lead_event_log clel2) AND clel.date_triggered < DATE_SUB(NOW(),INTERVAL :daysOld DAY)) AND campaign_id = :cmpId',
                    [':daysOld' => $daysOld, ':cmpId' => 12235],
                    [':daysold' => \PDO::PARAM_INT, ':cmpId' => \PDO::PARAM_INT],
                ],
            ],
